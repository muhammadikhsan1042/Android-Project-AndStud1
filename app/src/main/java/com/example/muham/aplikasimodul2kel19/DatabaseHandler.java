...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void updateUser(User usermodel){
        ...
        db.execSQL("update "+TABLE_MAHASISWA+" set "+KEY_NAME+"='"+usermodel.getUsername()+"',"
                +KEY_TALL+"='"+usermodel.getPassword()+"' where "+KEY_ID+"="+usermodel.getId()
        );
    ...
    public void deleteUser (int id){
        SQLiteDatabase db  = getWritableDatabase();
        db.execSQL("delete from "+TABLE_MAHASISWA+" where "+KEY_ID+" = " + id);
        db.close();
    }
